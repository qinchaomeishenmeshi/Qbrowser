...
class TestAPIIntegration:
    ...
    def mock_browser_service(self):
        ...
        with patch('api.api_server.browser_service') as mock_service:
            ...
            mock_service.stop_all_browsers = AsyncMock(return_value={
                'stopped': 2,
                'failed': 0
            })
            mock_service.get_browser_status = Mock(return_value={
                'running': True,
                'port': 9111,
                'user_id': 'user1'
            })
            mock_service.get_all_browser_status = Mock(return_value=[
    ...
    def test_start_browsers_success(self, client, mock_browser_service, sample_user_ids):
        """测试成功启动浏览器"""
    ...
    def test_get_extensions_status(self, client):
        ...
        with patch('api.api_server.get_extensions_status') as mock_get_status:
            mock_get_status.return_value = {
                ...
                "block_videos": {"enabled": False, "version": "1.0.0"}
            }
    ...
    def test_add_scheduler_task(self, client, mock_scheduler_client, sample_task_config):
        """测试添加调度器任务"""
    ...
    def test_get_logs(self, client):
        ...
        with patch('api.api_server.get_recent_logs') as mock_get_logs:
            mock_get_logs.return_value = [
                ...
                {"timestamp": "2024-01-01 10:01:00", "level": "ERROR", "message": "连接失败"}
            ]
