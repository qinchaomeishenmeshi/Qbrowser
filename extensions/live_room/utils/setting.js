...
const API = {
  ...
  originUrl: "https://hj.qwang.com.cn",
  // BaseUrl: 'http://113.57.110.35:13276/dev-api',
  ...
  // 发布成功的api
  updateAutoPublishTaskApi:
    "/videoclip/admin/autopublishtask/updateAutoPublishTask",
  // 记录失败日志的api
  ...
  // 保存违规信息
  liveviolationrecordsdealSaveApi:
    "/aiplay/admin/liveviolationrecordsdeal/save",
  // 保存直播复盘记录
  ...
  // 保存百应直播大屏信息
  livereplaydatadetailsynmessageApi:
    "/aiplay/admin/livereplaydatadetail/synmessage",
  // 获取ab数据 /DouyinLiveWebFetcher/api/get_sign_buyin
  getSignBuyinApi: "/DouyinLiveWebFetcher/api/get_sign_buyin",
};
...
const PAGE = {
  ...
  // 子账号内容管理页面 - 发布完成
  childContentPagePublished:
    "https://creator.douyin.com/content/manage?enter_from=publish",
  // 子账号发布管理页面
  ...
  // 子账号发布页面
  childPublishPage:
    "https://creator.douyin.com/content/publish?enter_from=publish_page",
  // 测试页面
  systemPage:
    "https://creator.douyin.com/content/publish?enter_from=publish_page",
